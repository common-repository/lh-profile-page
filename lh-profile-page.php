...
Plugin URI: http://lhero.org/plugins/lh-profile-page/
...
Copyright 2015  Peter Shaw  (email : pete@localhero.biz)
...
private function format_results( $results,$fields){
...
$return_string .= "<p>".$map[$result['key']]." updated</p>";
...
private function field_input( $userobject, $field, $source, $label, $placeholder, $type = "text", $required = "true", $open = "<p>", $close = "</p>"){
...
$return_string .= $open.'<!--[if lt IE 10]><br/><label for="lh_profile_page-'.$source.'-'.$field.'">'.$label.'</label><br/><![endif]-->';
...
$return_string .= $this->format_results($GLOBALS['lh_profile_page-update-result'],$fields);
